...
const RovingFocusRoot = ({ children, itemCount, orientation, dir, loop=true }:RovingFocusRootProps) => {
    ...
    return <RovingFocusContext.Provider value={{focusedIndex,setFocusedIndex,itemRefs,getNavigationKeys,moveFocus}}>
         {children}
